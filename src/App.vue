        ...
        <v-footer app height="25" dark d-flex="true">
          <template slot="default">
            <div class="ml-3">Created by Thien Reagan. Made with <span>
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="15" height="15" viewBox="0 0 48 48" version="1.1">
                <g id="surface1">   
                  <path style=" fill:#FF3D00;" d="M 32.636719 8 C 29.027344 8 25.855469 9.828125 24 12.597656 C 22.144531 9.828125 18.972656 8 15.363281 8 C 9.640625 8 5 12.597656 5 18.269531 C 5 28.488281 21.148438 33.410156 24 40 C 26.851563 33.410156 43 28.570313 43 18.269531 C 43 12.597656 38.359375 8 32.636719 8 "></path>
                </g>
              </svg>
              </span>
            </div>
...
export default {
  ...
  computed: {
    ...
    heartIcon () {
      return require('../assets/icons/heart-icon.svg')
    }
  },
  methods: {
